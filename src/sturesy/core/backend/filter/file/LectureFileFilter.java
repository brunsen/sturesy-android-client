...
public class LectureFileFilter implements FileFilter
{
    ...
    public boolean accept(File pathname)
    {
        ...
        boolean endsWithXML = pathname.getName().toLowerCase(Locale.US).endsWith(".xml");

        boolean notContainsVoting = !pathname.getName().toLowerCase(Locale.US).contains(VOTING);
