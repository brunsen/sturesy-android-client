...
public class WebCommands
{
     ...
     */
    public static String cleanVotes(String url, String lecturename, String password) throws JSONException
    {
    ...
    public static String getVotes(String url, String lecturename, String password) throws JSONException
    {
        JSONObject js = new JSONObject();
        js.put("command", "get");
        js.put("name", encode(lecturename));
    ...
    public static String getVotes(URL url, String lecturename, String password) throws JSONException
    {
        JSONObject js = new JSONObject();
        js.put("command", "get");
        js.put("name", encode(lecturename));
    ...
    public static String redeemToken(String url, String token) throws JSONException
    {
        JSONObject js = new JSONObject();
        js.put("token", token);
    ...
    public static String updateQuestion(String url, String lecturename, String password, QuestionModel model) throws JSONException
    {
        JSONObject js = new JSONObject();
        ...
        js.put("answers", new JSONArray(newAnswers));
        ...
        if (model instanceof MultipleChoiceQuestion)
        {
            ...
            js.put("answer", new JSONArray(mq.getCorrectAnswers()));
        }
    ...
    public static String getInfo(String url) throws JSONException
    {
        JSONObject js = new JSONObject();
        js.put("command", "info");
        js.put("time", System.currentTimeMillis() / 1000);
    ...
    public static String sendJSONObject(URL url, JSONObject obj, String hash)
    {
        ...
        jsString = Base64.encodeToString(jsString.getBytes(),Base64.DEFAULT);
    ...
    {
        String stripped = sturesy.util.HTMLStripper.stripHTML2(s);
