...
public class QTIImportService {
	...
	private Question parseQuestion(ZipFile zipfile, ZipEntry entry)
			throws IOException {
	...
	private boolean isSingleChoiceOnly(String text) {
		String[] incorrectTests = new String[] { "<assessmentTest",
	...
	private Question processXML(XmlPullParser xpp)
	...
	public class Question {
		...
		public String toString() {
			return "Question [questiontext=" + questiontext + ", type=" + type
					+ ", points=" + points + ", maxAnswers=" + maxAnswers
					+ ", basetype=" + basetype + "]";
		}
	}
